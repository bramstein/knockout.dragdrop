            ...
            init: function (element, valueAccessor) {
                ...
                ko.utils.registerEventHandler(element, 'dragenter', function (event) {
                    ...
                    if (source !== null && source !== element) {
                        if (dragEnter) {
                            return dragEnter(ko.dataFor(element), event, zone);
                        } else {
                ...
                ko.utils.registerEventHandler(element, 'dragleave', function (event) {
                    if (dragLeave) {
                        return dragLeave(ko.dataFor(element), event, zone);
                    }
                    return false;
                });
                ...
                ko.utils.registerEventHandler(element, 'drop', function (event) {
                    ...
                    if (drop) {
                        ...
                        drop(source && ko.dataFor(source) || null, ko.dataFor(element), event, zone);
                    }
                    return false;
                });
            }
